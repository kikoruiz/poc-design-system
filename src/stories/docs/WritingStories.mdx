...
import ArgstableImg from "@stories/assets/argstable.png";
...
<Title label="Variants and examples" />
...
<Title label="Live editable example" heading="h3" />

We created `@stories/ReactLiveBlock` to replace the `Canvas` component offered by Storybook.
